        ...
        <div class="card">
            <div class="card-body">
                <div class="text-center" style="margin-bottom:2rem;">
                    ...
                    <h2 style="font-weight:bold;margin-top:1rem;">Chào mừng đến VAChat</h2>
                    <p class="text-muted" style="margin-bottom:0.5rem;">Đăng nhập để tiếp tục</p>
                </div>
                <form id="loginForm">
                    <input type="text" id="loginUsername" class="form-control-lg" placeholder="Tên đăng nhập" required />
                    <input type="password" id="loginPassword" class="form-control-lg" placeholder="Mật khẩu" required />
                    <button type="submit" class="btn-lg btn-primary">Đăng nhập</button>
                </form>
                <p class="text-muted" style="text-align:center;">Chưa có tài khoản? <a href="#" id="showRegisterLink" style="font-weight:bold;">Đăng ký</a></p>
    ...
    document.getElementById('registerForm').onsubmit = async function (e) {
        ...
        try {
            ...
            if (data.success || data.token) {
                // Hiện popup đơn giản và chuyển về login sau 1.2s
